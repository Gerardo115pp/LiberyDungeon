...
var canShareContent UserCanChecker = factory_UserCanChecker(PlatformGrant_ShareContent, true)
...
func CanShareContent(grants []string) bool {
	return canShareContent(grants)
}
