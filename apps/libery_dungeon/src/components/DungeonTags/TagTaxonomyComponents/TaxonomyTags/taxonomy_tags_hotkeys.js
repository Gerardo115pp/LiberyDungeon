...
const taxonomy_tags_hotkeys = new ComponentHotkeyContext("taxonomy_tags");
...
taxonomy_tags_hotkeys.registerHotkeyAction(taxonomy_tags_actions.WASD_NAVIGATION, {
    overwrite_behavior: ComponentHotkeyContext.OVERRIDE_BEHAVIOR_IGNORE,
    hotkey_register_params: {
        hotkey_triggers: global_hotkey_movement_triggers,
        callback: HOTKEY_NULLISH_HANDLER,
        options: {
            description: HOTKEY_NULL_DESCRIPTION,
        },
...
export default taxonomy_tags_hotkeys;