<script>
    ...
    =============================================*/
        ...
        /**
         * The elements that are displayed in the moments ui list. This is either the clusters_video_moments or
         * another array generated by a search done by the user.
         * @type {VideoMomentIdentity[]}
         */
        let displayed_moments = [];
    ...
    =============================================*/
        ...
        async function loadClusterVideoMoments() {
            ...
            displayed_moments = cluster_video_moments;
        }

        /**
         * Handles search results from the VideoMomentSearchTool.
         * @param {VideoMomentIdentity[]} search_results
         * @returns {void}
         */
        const handleMomentSearchResults = search_results => {
            ...
            displayed_moments = search_results;
        }
...
>
    ...
    <div class="diviext-moments-wrapper">
        <ul class="diviext-moments dungeon-scroll">
            {#each displayed_moments as video_moment}
